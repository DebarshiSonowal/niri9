...
//       child: Scaffold(
//         body: SafeArea(
//           child: Consumer<Repository>(builder: (context, store, child) {
//             return Container(
...
//                         });
//                       },
//                       id: store.videoDetails?.series_id ?? 0,
...
//           if (repo.user!.has_subscription == true) {
...
//         // Set the video and reinitialize player
...
//         // Reinitialize the video player with the URL
...
//           // Reinitialize the video player with the first video
...
//       final trailerPlayer = videoDetails?.trailer_player;
//       if (trailerPlayer?.isNotEmpty ?? false) {
//         debugPrint("#condition ${videoDetails?.title} has trailer");

//         // Reinitialize with trailer player
//         _future = reinitializeVideoPlayer(context, trailerPlayer);
//       } else {
//         debugPrint(
...
//     // Trigger event only at specific intervals
