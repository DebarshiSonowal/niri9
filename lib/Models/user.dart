...
class User {
  ...
  User.fromJson(json) {
    ...
    last_rent = json["last_rent"]==false?null:LastRentDetails.fromJson(json['last_rent']);
    last_sub = json["last_subscription"]==null?null:LastSubscriptionsDetails.fromJson(json);
  }
}
